...
import com.springbank.user.cmd.api.security.PasswordEncoderBCrypt;
...
public class UserAggregate {
    ...
    public UserAggregate() {
        this.passwordEncoder = new PasswordEncoderBCrypt();
    }
    ...
    public void handle(UpdateUserCommand command) {
        ...
        var event = UpdateUserCommand.builder()
                .id(UUID.randomUUID().toString())
                .user(updatedUser)
                .build();

        AggregateLifecycle.apply(updatedUser);
